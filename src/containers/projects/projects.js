...
import {
  FullPageContainer,
  FullPagePanel,
} from "../../components/fullpage/fullpage";
  ...
  return (
    <div className="projects-section">
      ...
      <div className="project-image-gallery">
        ...
        >
          <div>{getCopy("projectsWatchGallery")}</div>
        </div>
      </div>
      <div className="projects-tech-stack">
        <div className="tech-stack-title">{getCopy("projectsStack")}</div>
      ...
      {fullscreenGallery && (
        <div className="projects-fullscreen-gallery">
          ...
          >
            ...
            <ButtonBack className="gallery-control-button gallery-back-button">
              <img src="/images/arrow.svg" />
            </ButtonBack>
            <ButtonNext className="gallery-control-button gallery-forward-button">
              <img src="/images/arrow.svg" />
            </ButtonNext>
          </CarouselProvider>
        </div>
